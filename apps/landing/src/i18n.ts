...
export const translations: Record<string, TranslationSet> = {
  ...
  'plan.free.f5': { id: 'Foto & Basic Scanner Preview', en: 'Basic photo & scanner preview', bn: 'Basic photo & scanner preview' },
  'plan.free.cta': { id: 'Start Now', en: 'Start Now', bn: 'Start Now' },

  'plan.plus.badge': { id: 'Barista Starter', en: 'Barista Starter', bn: 'Barista Starter' },
  ...
  'plan.plus.f2': { id: 'AI Chat Harian Terbatas', en: 'Limited AI Chat', bn: 'Limited AI Chat' },
  'plan.plus.f3': { id: 'Basic & Advanced Brew', en: 'Basic & Advanced Brew', bn: 'Basic & Advanced Brew' },
  'plan.plus.f4': { id: 'Lite & Pro Guide Brew', en: 'Lite and Pro Guide Brew', bn: 'Lite and Pro Guide Brew' },
  'plan.plus.f5': { id: 'Priority manual payment review', en: 'Priority manual payment review', bn: 'Priority manual payment review' },
  'plan.plus.cta': { id: 'Get Barista Starter', en: 'Get Barista Starter', bn: 'Get Barista Starter' },
  ...
  'plan.pro.f4': { id: 'AI Latte Art', en: 'AI Latte Art', bn: 'AI Latte Art' },
  'plan.pro.f5': { id: 'Seluruh fitur premium terbuka', en: 'All Premium Features Unlocked', bn: 'All Premium Features Unlocked' },
