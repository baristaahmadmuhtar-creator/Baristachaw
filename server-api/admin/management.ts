...
const PLAN_BLUEPRINTS: Omit<AdminPlan, 'activeUsers'>[] = [
  {
    ...
    priceMonthlyUsd: 0,
    aiDailyLimit: sharedAdminPlan('free').aiLimit,
    deepDailyLimit: sharedAdminPlan('free').deepLimit,
    scannerDailyLimit: sharedAdminPlan('free').scannerLimit,
    storageMb: 64,
    seats: 1,
    supportSlaHours: 72,
  ...
  },
  {
    ...
    aiDailyLimit: sharedAdminPlan('starter').aiLimit,
    deepDailyLimit: sharedAdminPlan('starter').deepLimit,
    scannerDailyLimit: sharedAdminPlan('starter').scannerLimit,
    storageMb: 512,
    seats: 1,
    supportSlaHours: 48,
  ...
  },
  {
    ...
    aiDailyLimit: sharedAdminPlan('pro').aiLimit,
    deepDailyLimit: sharedAdminPlan('pro').deepLimit,
    scannerDailyLimit: sharedAdminPlan('pro').scannerLimit,
    storageMb: 2048,
    seats: 1,
    supportSlaHours: 24,
  ...
  },
  {
    ...
    aiDailyLimit: sharedAdminPlan('team').aiLimit,
    deepDailyLimit: sharedAdminPlan('team').deepLimit,
    scannerDailyLimit: sharedAdminPlan('team').scannerLimit,
    storageMb: 10240,
    seats: 8,
    supportSlaHours: 12,
  ...
  },
  {
    ...
    priceMonthlyUsd: 0,
    aiDailyLimit: sharedAdminPlan('enterprise').aiLimit,
    deepDailyLimit: sharedAdminPlan('enterprise').deepLimit,
    scannerDailyLimit: sharedAdminPlan('enterprise').scannerLimit,
    storageMb: 102400,
    seats: 50,
    supportSlaHours: 4,
