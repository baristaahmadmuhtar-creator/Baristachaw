...
insert into public.app_plans (
  ...
  ('free', 'Free', 'Free tools for exploring coffee brewing — timer, ratio calculator, grind size calculator, and recipe collection.', 0, 12, 2, 2, 64, 1, 72, array['Brew Timer', 'Ratio Calculator', 'Grind Size Calculator', 'Recipe Collection & Notes', 'Limited daily AI Brew'], false, 'none', '', '', '', 'global', 'Free', 'disabled', '{}', 10),
  ('starter', 'Barista Plus', 'For serious home baristas — unlimited AI Brew, limited AI Chat, precision grinder calibration, and unlimited flavor profiles.', 2.50, 999, 40, 12, 512, 1, 48, array['All Free features', 'Unlimited AI Brew (Basic + Advanced)', 'AI Chat (15/day)', 'Precision grinder calibration', 'Unlimited flavor profiles'], true, 'revenuecat', 'baristachaw_starter_monthly', 'STRIPE_PRICE_STARTER_MONTHLY', 'starter', 'global', 'Rp 61.000 / B$ 1.80 / $1.50 monthly', 'external', array['Google Play', 'App Store', 'Stripe Checkout'], 20),
  ('pro', 'Barista Pro', 'Full professional toolkit — unlimited AI Chat, AI Scan, Latte Art Generator, and all upcoming features.', 4.99, 999, 120, 120, 2048, 1, 24, array['All Barista Plus features', 'Unlimited AI Chat', 'AI Scan & Coffee Analysis', 'AI Latte Art Generator', 'All upcoming features'], false, 'revenuecat', 'baristachaw_pro_monthly', 'STRIPE_PRICE_PRO_MONTHLY', 'pro', 'global', 'Rp 199.000 / B$ 6.00 / $4.99 monthly', 'external', array['Google Play', 'App Store', 'Stripe Checkout'], 30),
  ('team', 'Café Team', 'Cafe teams with shared operations, recipe SOP standardization, and multi-seat barista access.', 29.99, 800, 160, 240, 10240, 8, 12, array['All Barista Pro features', 'Team recipe SOP standardization', 'Batch brew calculations', 'Multi-seat team access', '12-hour priority support'], false, 'revenuecat', 'baristachaw_team_monthly', 'STRIPE_PRICE_TEAM_MONTHLY', 'team', 'global', 'Custom — contact us', 'external', array['Google Play', 'App Store', 'Stripe Checkout', 'Manual invoice'], 40),
