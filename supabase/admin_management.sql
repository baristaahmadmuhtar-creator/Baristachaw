...
insert into public.app_plans (
  ...
  ('free', 'Free', 'Free tools for exploring coffee brewing — timer, ratio calculator, grind size calculator, and recipe collection.', 0, 0, 0, 0, 64, 1, 72, array['Brew Timer', 'Ratio Calculator', 'Grind Size Calculator', 'Recipe Collection & Notes', 'Limited daily AI Brew'], false, 'none', '', '', '', 'global', 'Free', 'disabled', '{}', 10),
  ('starter', 'Barista Plus', 'For serious home baristas — unlimited AI Brew, limited AI Chat, precision grinder calibration, and unlimited flavor profiles.', 2.50, 50, 0, 5, 512, 1, 48, array['All Free features', 'Unlimited AI Brew (Basic + Advanced)', 'AI Chat (15/day)', 'Precision grinder calibration', 'Unlimited flavor profiles'], true, 'revenuecat', 'baristachaw_starter_monthly', 'STRIPE_PRICE_STARTER_MONTHLY', 'starter', 'global', 'Rp 61.000 / B$ 1.80 / $1.50 monthly', 'external', array['Google Play', 'App Store', 'Stripe Checkout'], 20),
