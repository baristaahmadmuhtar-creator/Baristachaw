...
const PLAN_BLUEPRINTS: AccountPlan[] = [
  {
    ...
    aiDailyLimit: sharedPlan('free').aiLimit,
    deepDailyLimit: sharedPlan('free').deepLimit,
    scannerDailyLimit: sharedPlan('free').scannerLimit,
    storageMb: 64,
    seats: 1,
    supportSlaHours: 72,
  ...
  },
  {
    ...
    aiDailyLimit: sharedPlan('starter').aiLimit,
    deepDailyLimit: sharedPlan('starter').deepLimit,
    scannerDailyLimit: sharedPlan('starter').scannerLimit,
    storageMb: 512,
    seats: 1,
    supportSlaHours: 48,
  ...
  },
  {
    ...
    aiDailyLimit: sharedPlan('pro').aiLimit,
    deepDailyLimit: sharedPlan('pro').deepLimit,
    scannerDailyLimit: sharedPlan('pro').scannerLimit,
    storageMb: 2048,
    seats: 1,
    supportSlaHours: 24,
  ...
  },
  {
    ...
    aiDailyLimit: sharedPlan('team').aiLimit,
    deepDailyLimit: sharedPlan('team').deepLimit,
    scannerDailyLimit: sharedPlan('team').scannerLimit,
    storageMb: 10240,
    seats: 8,
    supportSlaHours: 12,
  ...
  },
  {
    ...
    aiDailyLimit: sharedPlan('enterprise').aiLimit,
    deepDailyLimit: sharedPlan('enterprise').deepLimit,
    scannerDailyLimit: sharedPlan('enterprise').scannerLimit,
    storageMb: 102400,
    seats: 50,
    supportSlaHours: 4,
