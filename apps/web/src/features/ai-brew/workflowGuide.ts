...
function decorateAeroPressStyleGuideCopy(
  ...
  const targetStir = targetKey === 'balance_clean'
    ? copy.stir
    : `Aduk ${formatAeroPressStirCountId(calibration.stirCount)} sesuai target rasa. ${calibration.targetCue.id}.`;
  return {
    ...copy,
    stir: targetStir,
...
function buildAeroPressStyleGuideCopyBase(style: AeroPressGuideStyle, targetProfileId?: string) {
  switch (style) {
    case 'inverted':
      return {
        setup: 'Rakit posisi terbalik, bilas filter dan tutup.',
        setupSecondary: 'Rakit terbalik, bilas tutup, pastikan penekan masuk minimal 2 cm sebelum air masuk.',
        charge: 'Tuang air dan basahi semua bubuk.',
        chargeSecondary: 'Tuang air ke ruang seduh terbalik, basahi semua bubuk, dan jaga alat tetap tegak.',
        stir: 'Aduk 4x lalu tutup.',
        stirSecondary: 'Aduk 4 kali, pasang tutup rapat.',
        steep: 'Rendam diam sampai waktu balik.',
        steepSecondary: 'Rendam sampai waktu balik; ruang seduh tetap diam supaya ekstraksi merata.',
        flip: 'Balikkan mantap ke atas cangkir.',
        flipSecondary: 'Balikkan ke atas cangkir dalam satu gerakan mantap, tanpa mengguncang bubur kopi.',
        press: 'Tekan stabil 20-30 detik.',
        pressSecondary: 'Tekan 20-30s, berhenti sebelum desis kering.',
        stop: 'Stop sebelum desis.',
        stopSecondary: 'Stop sebelum desis, lalu angkat alat dari cangkir.',
        serve: 'Aduk pelan dan sajikan.',
        serveSecondary: 'Aduk cangkir pelan, lalu sajikan hasil rendaman penuh selagi aroma masih hidup.',
        stirChip: '4x',
    ...
    case 'bypass':
      if (targetProfileId === 'more_acidity') {
        return {
          ...
          charge: 'Isi konsentrat bersih.',
          chargeSecondary: 'Isi konsentrat bersih; bypass terpisah, tidak melewati kopi.',
          stir: 'Aduk 2-3 kali.',
          stirSecondary: 'Aduk 2-3x saja agar acidity tetap jernih.',
          steep: 'Rendam singkat.',
          steepSecondary: 'Rendam singkat; kontak cukup untuk konsentrat cerah tanpa membuat hasil terasa hollow.',
          flip: '',
          flipSecondary: '',
          press: 'Tekan ringan 20-30 detik.',
          pressSecondary: 'Tekan ringan 20-30s, stop sebelum desis.',
          stop: 'Stop sebelum desis.',
          stopSecondary: 'Berhenti sebelum desis agar acidity tidak berubah kasar.',
      ...
      if (targetProfileId === 'floral_transparent') {
        return {
          setup: 'Siapkan AeroPress tegak dan pisahkan air bypass.',
          setupSecondary: 'Siapkan tegak, bilas, pisahkan air bypass untuk menjaga hasil tetap ringan dan transparan.',
          charge: 'Isi air seduh sebagai konsentrat floral.',
          chargeSecondary: 'Isi air seduh sebagai konsentrat floral; bypass tidak lewat kopi.',
          stir: 'Aduk 2 kali ringan.',
          stirSecondary: 'Aduk 2 kali saja dengan gerakan ringan, lalu biarkan kontak berjalan tenang.',
          steep: 'Rendam singkat.',
          steepSecondary: 'Rendam singkat; tujuan utamanya clarity, bukan body berat.',
          flip: '',
          flipSecondary: '',
          press: 'Tekan sangat ringan 20-30 detik.',
          pressSecondary: 'Tekan s.ringan 20-30s, stop sebelum desis.',
          stop: 'Stop sebelum desis.',
          stopSecondary: 'Berhenti sebelum desis supaya akhir rasa tetap bersih.',
          serve: 'Tambah bypass lalu sajikan.',
          serveSecondary: 'Tambah bypass, aduk rata, sajikan.',
          stirChip: '2x',
          pressChip: '20-30 detik',
      ...
      if (targetProfileId === 'more_body' || targetProfileId === 'dense_comforting') {
        return {
          setup: 'Siapkan AeroPress tegak dan pisahkan air bypass.',
          setupSecondary: 'Siapkan tegak, bilas, ukur air bypass kecil agar body tidak terlalu encer.',
          charge: 'Isi konsentrat padat.',
          chargeSecondary: 'Isi konsentrat padat; bypass di cangkir setelah tekan.',
          stir: 'Aduk 4 kali.',
          stirSecondary: targetProfileId === 'dense_comforting'
            ? 'Aduk 4x untuk membangun tekstur sebelum fines naik berlebihan.'
            : 'Aduk 4x dengan stabil agar body terbentuk tanpa membuat hasil muddy.',
          steep: 'Rendam sedikit lebih panjang.',
          steepSecondary: 'Rendam sedikit lebih panjang agar konsentrat punya struktur sebelum diencerkan ringan.',
          flip: '',
          flipSecondary: '',
          press: 'Tekan pelan 25-35 detik.',
          pressSecondary: 'Tekan pelan 25-35s, stop sebelum desis kering.',
          stop: 'Stop sebelum desis.',
          stopSecondary: 'Stop sebelum desis; tekanan berlebih bisa membawa fines dan rasa pahit.',
          serve: 'Tambah bypass lalu sajikan.',
          serveSecondary: 'Tambah bypass, aduk rata, sajikan.',
          stirChip: '4x',
      ...
      if (targetProfileId === 'fruit_forward') {
        return {
          setup: 'Siapkan AeroPress tegak dan pisahkan air bypass.',
          setupSecondary: 'Siapkan tegak, bilas, pisahkan air bypass untuk menjaga aroma buah tetap hidup.',
          charge: 'Isi konsentrat aromatik.',
          chargeSecondary: 'Isi konsentrat aromatik; bypass tidak lewat kopi.',
          stir: 'Aduk 2-3x ringan.',
          stirSecondary: 'Aduk 2-3x dengan ringan, lalu biarkan rendaman tenang.',
          steep: 'Rendam singkat-menengah.',
          steepSecondary: 'Rendam singkat-menengah; jangan mengejar body sampai aroma buah terasa berat.',
          flip: '',
          flipSecondary: '',
          press: 'Tekan stabil 20-30 detik.',
          pressSecondary: 'Tekan stabil 20-30s, stop sebelum desis.',
          stop: 'Stop sebelum desis.',
          stopSecondary: 'Berhenti sebelum desis agar akhir rasa tidak terasa kasar.',
          serve: 'Tambah bypass lalu sajikan.',
          serveSecondary: 'Tambah bypass, aduk rata, sajikan.',
          stirChip: '2-3x',
          pressChip: '20-30 detik',
      ...
      if (targetProfileId === 'more_sweetness') {
        return {
          setup: 'Siapkan AeroPress tegak dan pisahkan air bypass.',
          setupSecondary: 'Siapkan tegak, bilas, pisahkan air bypass dalam porsi kecil-menengah.',
          charge: 'Isi konsentrat manis.',
          chargeSecondary: 'Isi konsentrat manis; bypass tidak lewat kopi.',
          stir: 'Aduk 3-4 kali.',
          stirSecondary: 'Aduk 3-4 kali agar ekstraksi tengah terbentuk.',
          steep: 'Rendam cukup.',
          steepSecondary: 'Rendam cukup untuk membangun sweetness tanpa menekan hasil sampai kering.',
          flip: '',
          flipSecondary: '',
          press: 'Tekan stabil 20-30 detik.',
          pressSecondary: 'Tekan stabil 20-30s, stop sebelum desis.',
          stop: 'Stop sebelum desis.',
          stopSecondary: 'Berhenti sebelum desis supaya rasa manis tidak berubah pahit.',
          serve: 'Tambah bypass lalu sajikan.',
          serveSecondary: 'Tambah bypass, aduk rata, sajikan.',
          stirChip: '3-4x',
          pressChip: '20-30 detik',
      ...
      return {
        ...
        stir: 'Aduk 3 kali.',
        stirSecondary: 'Aduk 3 kali untuk ekstraksi awal, lalu biarkan bubur kopi tenang singkat.',
        steep: 'Rendam singkat.',
        steepSecondary: 'Rendam singkat sebagai konsentrat; jaga kontak padat tanpa agitasi tambahan.',
        flip: '',
        flipSecondary: '',
        press: 'Tekan konsentrat 20-30 detik.',
        pressSecondary: 'Tekan konsentrat 20-30 detik dan berhenti sebelum desis.',
        stop: 'Stop sebelum desis.',
        stopSecondary: 'Berhenti sebelum desis agar konsentrat tidak menjadi kasar.',
        serve: 'Tambah bypass lalu sajikan.',
        serveSecondary: 'Tambah bypass, aduk rata, sajikan.',
        stirChip: '3x',
        pressChip: '20-30 detik',
    ...
    case 'no_bypass':
      return {
        setup: 'Siapkan AeroPress tegak dan bilas filter.',
        setupSecondary: 'Siapkan tegak, bilas, pastikan semua air resep memang masuk ruang seduh.',
        charge: 'Tuang seluruh air resep.',
        chargeSecondary: 'Tuang seluruh air resep ke ruang seduh; tidak ada air bypass tambahan setelah tekan.',
        stir: 'Aduk 3 kali.',
        stirSecondary: 'Aduk 3 kali, lalu biarkan bubur kopi tenang agar fase tekan tetap bersih.',
        steep: 'Rendam lebih panjang.',
        steepSecondary: 'Rendam lebih panjang sampai semua air di ruang seduh mengekstrak merata.',
        flip: '',
        flipSecondary: '',
        press: 'Tekan pelan 25-35 detik.',
        pressSecondary: 'Tekan pelan 25-35s, stop sebelum desis terasa kering; biarkan volume penuh turun bersih.',
        stop: 'Stop sebelum desis.',
        stopSecondary: 'Berhenti sebelum desis agar hasil penuh tetap bersih tanpa tambahan air.',
        serve: 'Aduk cangkir pelan dan sajikan.',
        serveSecondary: 'Aduk cangkir pelan dan sajikan tanpa air bypass tambahan.',
        stirChip: '3x',
        pressChip: '25-35 detik',
        stopChip: 'sebelum desis',
      };
    case 'bright_clean':
      return {
        setup: 'Bilas filter dan tutup, siapkan gaya bersih.',
        setupSecondary: 'Bilas filter dan tutup, gunakan segel rapi, dan siapkan gaya bersih dengan agitasi rendah.',
        charge: 'Tuang air cepat dan merata.',
        chargeSecondary: 'Tuang air cepat dan merata ke ruang seduh agar bubuk basah lengkap tanpa gerakan berat.',
        stir: 'Aduk 2-3x saja.',
        stirSecondary: 'Aduk 2-3x saja agar kejernihan tetap tinggi.',
        steep: 'Rendam singkat.',
        steepSecondary: 'Rendam singkat; kontak cukup untuk kejernihan tanpa membuat cangkir terasa berat.',
        flip: '',
        flipSecondary: '',
        press: 'Tekan sangat stabil 20-30 detik.',
        pressSecondary: 'Tekan sangat stabil 20-30 detik dengan tenaga ringan.',
        stop: 'Berhenti sebelum desis pertama.',
        stopSecondary: 'Berhenti sebelum desis pertama agar akhir rasa tetap bersih.',
        serve: 'Aduk cangkir sekali dan sajikan.',
        serveSecondary: 'Aduk cangkir sekali dan sajikan tanpa air tambahan.',
        stirChip: '2-3x',
        pressChip: '20-30 detik',
        stopChip: 'sebelum desis',
      };
    case 'sweet_body':
      return {
        setup: 'Hangatkan ruang seduh, siapkan gaya seduh.',
        setupSecondary: 'Hangatkan ruang seduh, bilas filter dan tutup, lalu siapkan gaya seduh untuk tekstur manis.',
        charge: 'Tuang air ke ruang seduh.',
        chargeSecondary: 'Tuang air ke ruang seduh dan basahi bubuk sampai penuh merata.',
        stir: 'Aduk silang 5 kali.',
        stirSecondary: 'Aduk silang 5 kali untuk membangun tekstur, lalu biarkan bubur kopi tenang.',
        steep: 'Rendam lebih panjang.',
        steepSecondary: 'Rendam lebih panjang agar rasa manis dan tekstur terkumpul.',
        flip: '',
        flipSecondary: '',
        press: 'Tekan pelan 25-35 detik.',
        pressSecondary: 'Tekan pelan 25-35 detik sampai mendekati desis; jangan paksa tekanan bila rasa mulai pahit atau kering.',
        stop: 'Berhenti mendekati desis.',
        stopSecondary: 'Berhenti mendekati desis. Gaya ini mengejar body, tetapi tekanan berlebih bisa membawa fines dan rasa pahit.',
        serve: 'Aduk cangkir pelan dan sajikan.',
        serveSecondary: 'Aduk cangkir pelan dan sajikan sebagai cangkir tebal tanpa air tambahan.',
        stirChip: '5x',
        pressChip: '25-35 detik',
    ...
    default:
      return {
        setup: 'Siapkan AeroPress tegak di atas cangkir.',
        setupSecondary: 'Siapkan AeroPress tegak di atas cangkir, bilas filter dan tutup, pastikan segel rapat, lalu tara timbangan.',
        charge: 'Tuang air dan basahi bubuk merata.',
        chargeSecondary: 'Tuang air ke ruang seduh dan basahi bubuk kopi merata.',
        stir: 'Aduk 3 kali santai.',
        stirSecondary: 'Aduk 3 kali atau swirl ringan sekali.',
        steep: 'Rendam diam.',
        steepSecondary: 'Rendam sampai waktu tekan; ruang seduh tetap stabil dan tertutup.',
        flip: '',
        flipSecondary: '',
        press: 'Tekan stabil 20-30 detik.',
        pressSecondary: 'Tekan 20-30s, berhenti sebelum desis kering.',
        stop: 'Stop sebelum desis.',
        stopSecondary: 'Stop sebelum desis, lalu pisahkan alat dari cangkir.',
        serve: 'Aduk cangkir pelan, lalu sajikan.',
        serveSecondary: 'Aduk cangkir pelan, lalu sajikan.',
        stirChip: '3x',
        pressChip: '20-30 detik',
        stopChip: 'sebelum desis',
      };
