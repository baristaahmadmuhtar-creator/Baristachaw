  ...
  id: {
    home: {
      ...
      auth: {
        ...
        offlineBody: 'Akses tersimpan masih terbuka. Pencarian langsung kembali setelah tersambung.',
        expiredTitle: 'Sesi berakhir',
        expiredBody: 'Masuk lagi untuk memulihkan pencarian langsung dan penyimpanan sinkron.',
        signedInTitle: 'Sudah masuk',
        signInTitle: 'Masuk untuk pencarian langsung',
        signInBodyGuest: 'Alat tamu tetap terbuka.',
        signInBodyCloud: 'Aksi sinkronisasi memerlukan masuk.',
      },
      search: {
        ...
        deepFallback: 'Pencarian web langsung tidak tersedia. Menampilkan cadangan mendalam.',
      ...
      sections: {
        ...
        quickPathsSubtitle: 'Masuk langsung ke alur kerja utama.',
        accountTitle: 'Akun',
        accessTitle: 'Akses',
    ...
    chat: {
      ...
      helpers: {
        ...
        deepThinking: 'Berpikir mendalam',
        ...
        openChatTools: 'Buka alat obrolan',
        ...
        workspaceRole: 'Peran ruang kerja',
        workflowFocus: 'Fokus alur kerja',
        ...
        defaultName: 'Nama bawaan',
        defaultAssistantName: 'Nama asisten bawaan',
        adaptiveDetail: 'Detail adaptif',
        flexibleFormat: 'Format fleksibel',
        neutralTone: 'Nada netral',
        noWorkspaceRole: 'Belum ada peran ruang kerja',
        noWorkflowFocus: 'Belum ada fokus alur kerja',
        styleNoteSaved: 'Catatan gaya tersimpan',
        noStyleNotes: 'Belum ada catatan gaya',
        defaultEmoji: 'Emoji bawaan',
      ...
      header: {
        signedOut: 'Masuk untuk mengirim pesan, menyimpan balasan, dan menyimpan riwayat obrolan.',
        offline: 'Sambungkan kembali untuk mengirim, berbicara, atau membuat gambar.',
        ready: 'Minta resep, pemecahan masalah, atau ulasan alur kerja.',
      },
      status: {
        ...
        savedTitle: 'Tersimpan ke Koleksi',
        savedBody: 'Respons asisten terbaru siap di Koleksi.',
      },
      sheets: {
        ...EN_CHAT.sheets,
        historySubtitle: 'Sesi dan folder',
        newChatSubtitle: 'Buat dan pindah percakapan.',
        sessionsTitle: 'Sesi',
        sessionsSubtitle: 'Pindahkan, ubah nama, atau buka percakapan.',
        emptySessionPreview: 'Mulai pesan untuk membangun percakapan ini.',
