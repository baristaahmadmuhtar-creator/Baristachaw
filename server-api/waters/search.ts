...
import { initCatalogRequest, readLimit, readMode, readRegion, readSearchQuery } from '../_catalog.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const result = searchCatalog(catalog.waters, region, readSearchQuery(req), readLimit(req), { mode });
