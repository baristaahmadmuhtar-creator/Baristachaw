...
const STYLE_BASE: Record<ResolvedAeroPressStyle, AeroPressBaseTarget> = {
  ...
  inverted: {
    finalRatio: 14.5,
    concentrateRatio: null,
    finishRangeSeconds: [80, 135],
    tempRangeC: [88, 93],
    stirCount: '4x',
  },
  bypass: {
    finalRatio: 14.5,
    concentrateRatio: 9.5,
    finishRangeSeconds: [60, 100],
    tempRangeC: [88, 93],
...
const BYPASS_TARGETS: Record<string, AeroPressBaseTarget> = {
  ...
  more_body: {
    finalRatio: 13.0,
    concentrateRatio: 10.5,
    finishRangeSeconds: [105, 160],
    tempRangeC: [88, 93],
  ...
  more_sweetness: {
    finalRatio: 14.0,
    concentrateRatio: 9.0,
    finishRangeSeconds: [85, 125],
    tempRangeC: [88, 93],
    bypassRangePercent: [20, 35],
    stirCount: '4x',
