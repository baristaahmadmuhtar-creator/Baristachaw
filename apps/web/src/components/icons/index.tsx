...
export const CreditCard = buildIcon('CreditCard');
export const Crown = buildIcon('Crown');
export const AtSign = buildIcon('AtSign');
export const Lock = buildIcon('Lock');
export const Eye = buildIcon('Eye');
export const EyeOff = buildIcon('EyeOff');
export const UserRound = buildIcon('UserRound');
export const Download = buildIcon('Download');
export const WifiOff = buildIcon('WifiOff');
export const ArrowRight = buildIcon('ArrowRight');
