...
export const PLAN_CATALOG: PlanCatalogEntry[] = [
  {
    ...
    priceMonthlyUsd: 0,
    features: ['Brew Timer', 'Grind Size Calculator', 'Coffee Ratio Calculator', 'Recipe Collection & Notes', 'Basic scanner preview'],
    aiAccess: 'basic',
    expensiveModes: ['fast'],
  ...
  },
  {
    ...
    features: ['Everything in Free', 'AI recipe guidance', 'Advanced brew logging', 'Scanner history', 'Priority manual payment review'],
    aiAccess: 'guided',
  ...
  },
  {
    ...
    features: ['Everything in Barista Starter', 'AI BREW COACH', 'AI Scan & Coffee Analysis', 'AI Latte Art Generator', 'Deep mode with higher credit use'],
    aiAccess: 'coach',
