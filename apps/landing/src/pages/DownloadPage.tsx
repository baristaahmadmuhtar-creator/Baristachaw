    ...
    return (
      <main className="utility-page">
        <div className="utility-hero">
          ...
          <h1>
            {isIos
              ? label(language, 'iOS sekarang. App Store segera hadir.', 'iOS now. App Store coming soon.', 'iOS sekarang. App Store akan datang.')
              : label(language, 'Android tersedia. Google Play segera hadir.', 'Android is available. Google Play coming soon.', 'Android tersedia. Google Play akan datang.')}
          </h1>
          <p>
            {isIos
              ? label(
          ...
          <div className="utility-actions">
            {isIos ? (
              <a className="button button-primary" href={APP_LINKS.home}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="6" y="2" width="12" height="20" rx="3" /><line x1="12" y1="18" x2="12" y2="18.01" /></svg> {label(language, 'Install iOS', 'Install iOS', 'Install iOS')}
              </a>
            ) : (
    ...
    <main className="utility-page">
      <div className="utility-hero">
        ...
        <p>
          {label(
            language,
            `Pakai iOS dari Safari atau download Android ${RELEASE_VERSION} sebagai signed release.`,
            `Use iOS from Safari or download Android ${RELEASE_VERSION} as a signed release.`,
            `Pakai iOS dari Safari atau muat turun Android ${RELEASE_VERSION} sebagai signed release.`,
          )}
        </p>
        <div className="utility-actions">
        ...
        <div className="download-card">
          <div className="download-product">
            ...
            <div>
              ...
              <span>{label(language, 'iOS dan Android', 'iOS and Android', 'iOS dan Android')}</span>
            </div>
          </div>
          <div className="download-facts">
            <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{display:'inline',verticalAlign:'middle'}}><rect x="6" y="2" width="12" height="20" rx="3" /><line x1="12" y1="18" x2="12" y2="18.01" /></svg> iOS - {label(language, 'App Store segera hadir', 'App Store coming soon', 'App Store akan datang')}</span>
