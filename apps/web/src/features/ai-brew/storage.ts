...
const AI_BREW_FORM_STORAGE_KEY = 'BARISTACLAW_AI_BREW_FORM_V5';
const AI_BREW_CATALOG_SNAPSHOT_STORAGE_KEY = 'BARISTACLAW_AI_BREW_CATALOG_SNAPSHOT_V5';
const AI_BREW_LAST_PLAN_STORAGE_KEY = 'BARISTACLAW_AI_BREW_LAST_PLAN_V5';
