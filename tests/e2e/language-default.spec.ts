...
const ENGLISH_FORBIDDEN_INDONESIAN_COPY =
  /Alat Barista|Kalkulator|Tugas|Preset Metode Seduh|Ukuran Giling|Dosis \(g\)|Air \(ml\)|Ringkasan|Panduan Seduh|Detail tambahan|Prediksi rasa|Keyakinan|Keamanan|Simpan|Hapus|Buka katup|Air turun|Cek rasa|Seduhan Terbaru|Pakai di Timer|Pakai di Rasio|Simpan ke Koleksi|Asisten AI|Profil kopi|Detail kopi|Menyusun seduhan/i;
