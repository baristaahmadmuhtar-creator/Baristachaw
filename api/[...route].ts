...
const ROUTE_LOADERS: Record<string, () => Promise<{ default: Handler }>> = {
  ...
  'auth/email/reset': () => import('../server-api/auth/email.js'),
  'auth/email/update-password': () => import('../server-api/auth/email.js'),
  'auth/email/otp/send': () => import('../server-api/auth/email.js'),
  'auth/email/otp/verify': () => import('../server-api/auth/email.js'),
  'auth/email/password/reset/start': () => import('../server-api/auth/email.js'),
  'auth/email/password/reset/verify': () => import('../server-api/auth/email.js'),
  'auth/email/password/reset/update': () => import('../server-api/auth/email.js'),
  ...
  'auth/account-recovery': () => import('../server-api/auth/account-recovery.js'),
  ...
  'admin/proof-view': () => import('../server-api/admin/proofView.js'),
  'admin/proof_view': () => import('../server-api/admin/proofView.js'),
  ...
  'billing/pricing': () => import('../server-api/billing/pricing.js'),
